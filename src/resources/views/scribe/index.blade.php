...
<head>
    ...
    <title>Locadora API API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-logout">POST /api/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-vehicles-search">
                                <a href="#endpoints-GETapi-vehicles-search">GET api/vehicles/search</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-vehicles">POST api/vehicles</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-vehicles--id-">
                                <a href="#endpoints-GETapi-vehicles--id-">GET api/vehicles/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-reports-revenue">GET /api/reports/revenue?start=YYYY-MM-DD&end=YYYY-MM-DD</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-rentals">POST api/rentals</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-rentals--rental_id--start">
                                <a href="#endpoints-POSTapi-rentals--rental_id--start">POST api/rentals/{rental_id}/start</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-rentals--rental_id--end">
                                <a href="#endpoints-POSTapi-rentals--rental_id--end">POST api/rentals/{rental_id}/end</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-rentals">
                                <a href="#endpoints-GETapi-rentals">GET api/rentals</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-rentals--rental_id-">
                                <a href="#endpoints-GETapi-rentals--rental_id-">GET api/rentals/{rental_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-vehicles-search">GET api/vehicles/search</h2>
...
<span id="example-requests-GETapi-vehicles-search">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/vehicles/search" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/vehicles/search"
);
...
<span id="example-responses-GETapi-vehicles-search">
            <blockquote>
...
<span id="execution-results-GETapi-vehicles-search" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-vehicles-search"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-vehicles-search"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-vehicles-search" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-vehicles-search">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-vehicles-search" data-method="GET"
      data-path="api/vehicles/search"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-vehicles-search', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-vehicles-search"
                    onclick="tryItOut('GETapi-vehicles-search');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-vehicles-search"
                    onclick="cancelTryOut('GETapi-vehicles-search');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-vehicles-search"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/vehicles/search</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-vehicles-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-vehicles-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="plate"                data-endpoint="POSTapi-vehicles"
               value="bngzmi"
               data-component="body">
    <br>
...
<p>Must not be greater than 50 characters. Example: <code>v</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>daily_rate</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="daily_rate"                data-endpoint="POSTapi-vehicles"
               value="42"
               data-component="body">
    <br>
<p>Must be at least 0. Example: <code>42</code></p>
                    ...
                    <h2 id="endpoints-GETapi-vehicles--id-">GET api/vehicles/{id}</h2>
...
<p>The ID of the vehicle. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-reports-revenue">GET /api/reports/revenue?start=YYYY-MM-DD&amp;end=YYYY-MM-DD</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="start"                data-endpoint="GETapi-reports-revenue"
               value="2025-05-02T07:46:07"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-05-02T07:46:07</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="end"                data-endpoint="GETapi-reports-revenue"
               value="2051-05-26"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start</code>. Example: <code>2051-05-26</code></p>
        </div>
        </form>
...
<p>Must not be greater than 20 characters. Example: <code>iyvdljnikhwaykcm</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>cnh</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="cnh"                data-endpoint="POSTapi-customers"
               value="architecto"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/customers/3" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="cnh"                data-endpoint="PUTapi-customers--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<form id="form-POSTapi-rentals" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-rentals');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-rentals"
                    onclick="cancelTryOut('POSTapi-rentals');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="vehicle_id"                data-endpoint="POSTapi-rentals"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the vehicles table. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="customer_id"                data-endpoint="POSTapi-rentals"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the customers table. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-rentals--rental_id--start">POST api/rentals/{rental_id}/start</h2>
...
<span id="example-requests-POSTapi-rentals--rental_id--start">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/rentals/1/start" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-rentals--rental_id--start">
</span>
<span id="execution-results-POSTapi-rentals--rental_id--start" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-rentals--rental_id--start"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-rentals--rental_id--start"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-rentals--rental_id--start" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-rentals--rental_id--start">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-rentals--rental_id--start" data-method="POST"
      data-path="api/rentals/{rental_id}/start"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-rentals--rental_id--start', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-rentals--rental_id--start"
                    onclick="tryItOut('POSTapi-rentals--rental_id--start');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-rentals--rental_id--start"
                    onclick="cancelTryOut('POSTapi-rentals--rental_id--start');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-rentals--rental_id--start"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/rentals/{rental_id}/start</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-rentals--rental_id--start"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-rentals--rental_id--start"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>rental_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rental_id"                data-endpoint="POSTapi-rentals--rental_id--start"
               value="1"
               data-component="url">
    <br>
<p>The ID of the rental. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-POSTapi-rentals--rental_id--end">POST api/rentals/{rental_id}/end</h2>
...
<span id="example-requests-POSTapi-rentals--rental_id--end">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/rentals/1/end" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-rentals--rental_id--end">
</span>
<span id="execution-results-POSTapi-rentals--rental_id--end" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-rentals--rental_id--end"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-rentals--rental_id--end"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-rentals--rental_id--end" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-rentals--rental_id--end">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-rentals--rental_id--end" data-method="POST"
      data-path="api/rentals/{rental_id}/end"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-rentals--rental_id--end', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-rentals--rental_id--end"
                    onclick="tryItOut('POSTapi-rentals--rental_id--end');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-rentals--rental_id--end"
                    onclick="cancelTryOut('POSTapi-rentals--rental_id--end');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-rentals--rental_id--end"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/rentals/{rental_id}/end</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-rentals--rental_id--end"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-rentals--rental_id--end"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rental_id"                data-endpoint="POSTapi-rentals--rental_id--end"
               value="1"
               data-component="url">
    <br>
<p>The ID of the rental. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-rentals">GET api/rentals</h2>
...
<span id="example-requests-GETapi-rentals">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/rentals" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-rentals">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-rentals" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-rentals"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-rentals"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-rentals" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-rentals">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-rentals" data-method="GET"
      data-path="api/rentals"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-rentals', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-rentals"
                    onclick="tryItOut('GETapi-rentals');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-rentals"
                    onclick="cancelTryOut('GETapi-rentals');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-rentals"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-rentals"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-rentals"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-rentals--rental_id-">GET api/rentals/{rental_id}</h2>
...
<span id="example-requests-GETapi-rentals--rental_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/rentals/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-rentals--rental_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-rentals--rental_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-rentals--rental_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-rentals--rental_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-rentals--rental_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-rentals--rental_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-rentals--rental_id-" data-method="GET"
      data-path="api/rentals/{rental_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-rentals--rental_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-rentals--rental_id-"
                    onclick="tryItOut('GETapi-rentals--rental_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-rentals--rental_id-"
                    onclick="cancelTryOut('GETapi-rentals--rental_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-rentals--rental_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/rentals/{rental_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-rentals--rental_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-rentals--rental_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rental_id"                data-endpoint="GETapi-rentals--rental_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the rental. Example: <code>1</code></p>
